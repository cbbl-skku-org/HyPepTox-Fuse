...
class NLP_Dataset_Load_One_Sample(Dataset):
    def __init__(self, dataset_root, 
                 feature_1_name, 
                 feature_2_name, 
                 feature_3_name, 
    ...
    def __getitem__(self, index):
        pep_key = self.pep_keys[index]
        f1, f2, f3 = self.get_data(pep_key)
        label = self.labels[index]
...
class Hybrid_Dataset_Load_One_Sample(Dataset):
    def __init__(self, dataset_root, 
                 feature_1_name, 
                 feature_2_name, 
                 feature_3_name,
    ...
    def get_data(self, key):
        ...
        return f1, f2, f3, hc_f
    
    def __getitem__(self, index):
        pep_key = self.pep_keys[index]
        f1, f2, f3, hc_f = self.get_data(pep_key)
        label = self.labels[index]
