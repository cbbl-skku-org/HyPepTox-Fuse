...
from src.lightning_module import HyPepToxFuse_NLP_Trainer
from src.dataset_module import NLP_Dataset
...
def main(args):
    ...
    for fold, (train_indices, val_indices) in enumerate(kfold.split(train_dataset.pep_keys, train_dataset.labels)):
        ...
        model = HyPepToxFuse_NLP_Trainer(args.model_config, args.trainer_config)
        model.to(device)
